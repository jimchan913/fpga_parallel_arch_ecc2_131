...
(input wire [n-1:0] a, input wire [n-1:0] b,output wire [2*n-2:0] y);
   ...
   OKA_L2_66bit mult_66bit_1(.y(y_odd), .a(a_odd), .b(b_odd));
   OKA_L2_66bit mult_66bit_2(.y(y_even), .a(a_even), .b(b_even));
   OKA_L2_66bit mult_66bit_3(.y(y_even_xor_odd), .a(a_even_xor_odd), .b(b_even_xor_odd));
