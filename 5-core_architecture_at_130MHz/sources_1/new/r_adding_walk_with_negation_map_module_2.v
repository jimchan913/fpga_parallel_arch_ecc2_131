...
module r_adding_walk_with_negation_map_module_2 #(parameter n = 131)(input wire clk, input wire rst_n, input wire start_enable,
 ...
 precomputed_starting_point_coord_x_table_2 starting_point_coord_x_table(.clk(clk), .en(read_enable_for_precomputed_tables), .addr(i_reg), .table_value_x(sp_coord_x));  
 precomputed_starting_point_coord_y_table_2 starting_point_coord_y_table(.clk(clk), .en(read_enable_for_precomputed_tables), .addr(i_reg), .table_value_y(sp_coord_y));
 precomputed_starting_point_coeff_c_table_2 starting_coeff_c_table(.clk(clk), .en(read_enable_for_precomputed_tables), .addr(i_reg), .coeff_c(starting_points_coeff_c));
